...
# @a2ml-metadata begin
# (
#   id                   = "boj-server-mk2-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "boj-server-mk2"
#   app-display          = "BOJ Server MK2"
...
#
# ============================================================================
# boj-server-mk2-launcher.sh — BOJ Server MK2
# ============================================================================
# GENERATED by launch-scaffolder from boj-server-mk2.launcher.a2ml.
...
APP_NAME="boj-server-mk2"
APP_DISPLAY="BOJ Server MK2"
APP_DESC="Server"
APP_CATEGORIES="Development;System;"
APP_GENERIC_NAME="BOJ Server MK2"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/boj-server-mk2/boj-server-mk2.launcher.a2ml"

URL="http://localhost:3000"
APP_PORT="3000"
WAIT_SECONDS="15"

PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/boj-server-mk2.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/boj-server-mk2/server.log"

# Search list from [runtime].startup-command-search — first executable wins.
START_COMMAND=""
for candidate in \
    "/target/release/boj-server" \
    "/boj-server" \
    "boj-server" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in boj-server-mk2.launcher.a2ml."
            return 1
        fi
    fi
