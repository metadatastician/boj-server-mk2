...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/boj-server-mk2/security/advisories/new)
...
- This repository (`metadatastician/boj-server-mk2`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/boj-server-mk2/security/advisories)
...
When using boj-server-mk2, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/boj-server-mk2/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/boj-server-mk2/security/advisories/new) or jonathan.jewell@gmail.com |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/boj-server-mk2/discussions) |
...
*Thank you for helping keep boj-server-mk2 and its users safe.* 🛡️
