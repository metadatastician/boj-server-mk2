...
# BoJ Server Mk2 container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping boj-server-mk2..."
...
# Examples:
#   exec /app/boj-server-mk2
#   exec /app/release/bin/boj-server-mk2 start
#   exec /app/boj-server-mk2 serve --host "${APP_HOST}" --port "${APP_PORT}"
