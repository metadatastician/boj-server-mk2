...
= local-coord-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `local-coord-mcp`. Defines the data, tool, and
...
2 Idris2 module(s), ~512 lines total. Lead module:
`SafeLocalCoord.idr`.
...
. `SafeLocalCoord.idr` — cartridge-local data records and enums.
