...
= model-router-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `model-router-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~59 lines total. Lead module:
`Protocol.idr`.
