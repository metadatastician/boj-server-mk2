...
= ml-mcp / abi — Idris2 ABI layer
:orientation: shallow

== Purpose

Cartridge-local protocol types for `ml-mcp`. Defines the data, tool, and
...
1 Idris2 module(s), ~205 lines total. Lead module:
`SafeMl.idr`.
...
. `SafeMl.idr` — cartridge-local data records and enums.
