...
// Replace boj-server-mk2, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= boj-server-mk2 — Quick Start for Users
:toc:
:toclevels: 2

== What is boj-server-mk2?
...
[source,bash]
----
just install --portable --prefix=./boj-server-mk2-portable
----
...
* **Wiki**: https://github.com/metadatastician/boj-server-mk2/wiki
