...
= Contributing — BoJ Server Mk2
:revdate: 2026-MM-DD

== Audience

Developers working *on* `BoJ Server Mk2`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/BoJ Server Mk2.git
cd BoJ Server Mk2
...
* Bugs in `BoJ Server Mk2`: file at `metadatastician/BoJ Server Mk2/issues`.
