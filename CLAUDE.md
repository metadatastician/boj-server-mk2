...
# This repo: `boj-server-mk2`  ·  clade `rm-boj-server-mk2`

- **Identity** — uuid `a5ea1382-a34c-5334-8a46-a2ebe904c810`; clade `rm` (secondary `gv`); born 2026-03-16; forge `metadatastician/boj-server-mk2`.
...
- **Where it sits** — pipeline position **foundation**; chain `standards → boj-server-mk2 → (every estate repo)`; coordination = `standards`.
